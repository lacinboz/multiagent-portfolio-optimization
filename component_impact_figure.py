...
fig.suptitle(
    "Component-Level Portfolio Impact by Feature Set "
...
ax1.set_ylabel("ΔSharpe (vs. unconstrained baseline)")
ax1.set_xticks(x)
ax1.set_xticklabels(data["feature_sets"], fontsize=8.5)
...
ax2.set_xticks(x)
ax2.set_xticklabels(data["feature_sets"], fontsize=8.5)
